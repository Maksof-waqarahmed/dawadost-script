    ...
    for (let medicineRoute of medicines) {
        try {
            ...
            await client.query(setQuery, [
                JSON.stringify({
                    primary: keyWords.primary_keywords?.english,
                    secondary: keyWords.secondary_keywords?.english,
                    mostly_searched: keyWords.mostly_searched_words?.english,
                }),
