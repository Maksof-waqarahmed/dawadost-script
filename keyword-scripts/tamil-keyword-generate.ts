    ...
    for (let medicineRoute of medicines) {
        try {
            ...
            await client.query(setQuery, [
                JSON.stringify({
                    primary: keyWords.primary_keywords?.tamil,
                    secondary: keyWords.secondary_keywords?.tamil,
                    mostly_searched: keyWords.mostly_searched_words?.tamil,
                }),
